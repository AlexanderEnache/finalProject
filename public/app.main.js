...
//create table noneofit(id serial, name varchar(200), type varchar(20), category varchar(50), color varchar(50), price float, description varchar(1000), year int, region varchar(100), abv int, image varchar(1000), quantity int, pricedate varchar(2000));
